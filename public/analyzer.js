    ...
    if (result.status === "rate-limited") {
        return `
            <div class="issue warning">
                ...
                <p style="margin-top: 10px; font-size: 13px; color: #7f8c8d;">This tool uses a free-tier AI provider with limited capacity. Interested in a paid tier with higher limits? <a href="https://forms.gle/W2xPf67LTkpf3CuS7" target="_blank" class="docs-link">Let me know</a>.</p>
            </div>
        `;
    }
